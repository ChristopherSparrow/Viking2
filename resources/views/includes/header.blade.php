<nav class="navbar navbar-dark bg-viking ">
    <div class="container-fluid">
        <a class="navbar-brand"  href="{{ url('/') }}"><img src={{ asset('images/logo.png') }} width="40" height="40" class="d-inline-block align-top" alt="Viking Pool League Icon">&nbsp; Viking Pool League</a>

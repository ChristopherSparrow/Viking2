...
<div class="row">
    ...
    <div class="col-lg-4 mb-2">
        <div class="card shadow p-30 mb-4 bg-white rounded">
            <div class="card-header d-flex justify-content-between align-items-center">{{ $team->team_name }} <a href="{{ route('teams.edit', ['seasonId' => $season->id, 'teamId' => $team->id]) }}">  <i class="bi bi-pencil-square"></i>  Edit</a></div>
                <div class="card-body">
